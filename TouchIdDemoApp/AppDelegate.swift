...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func getPathOfDataFiles() -> String {
        ...
        let documentsPath = pathsArray[0] as NSString
        let dataFilePath = documentsPath.appendingPathComponent("notesData")
        return dataFilePath
    }
    
    func checkIfDataFileExists() -> Bool {
        if FileManager.default.fileExists(atPath: getPathOfDataFiles()) {
            return true
        }
        return false
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "TouchIdDemoApp")
